...
It is a challenge to keep up with the changing technologies and practices related to front-end development.
This post lists the free resources, for the technologies and concepts one must know to become a front-end developer.

**Note : I'll keep this list updated, as the landscape that is front-end keeps changing.** 👍🏻
...
These lines from Wikipedia sums up front-end development aptly.
At the core, we are using **HTML**, **CSS** and **Javascript**, along with other related tools & technologies to create websites or web applications.
There are many great resources available online both paid and free. This guide lists only the **free** resources that I came across on my journey to become a front-end developer. ( Still on my way. 😊 )

I have created three sections for this guide :
...
Each section consist of sub-sections such as _**videos**_ , _**websites**_, or _**online books**_ for corresponding related technologies.
...
**Cascading Style Sheets (CSS)** allows you to style your web page once you have structured it.
...
The following websites may prove useful to better understand certain concepts you otherwise couldn't wrap your head around.
...
**Javascript** is a programming language used to add functionality to your web pages and make them more dynamic.
...
For any front-end developer, tools such as a text editor and browsers provide powerful capabilities. When mastered they make your development process easier. Below I have listed such tools & technologies and resources that will help you master them.
...
There is also what is called the _'Developer Edition'_ of popular browsers, that are marketed to developers.
These browsers implement the latest technologies, and powerful tools that simplify debugging and testing.

-   [**Chrome Canary**][40]

-   [**Firefox Developer Edition**][41]

_Note: There is also **Safari** and **Microsoft Edge** that are available for MacOS and Microsoft Windows respectively._
...
_Note: Dev Tools work mostly same on every browser. If you are using browser other than Chrome or Firefox than I suggest that you learn dev tools using Chrome / Firefox._
...
There are many VCS in use today. The most popular is Git which was created by [Linus Torvalds][44], who created the linux kernel. Part of the reason git became popular as it is today is because of Github. Github allows you to host your code online and integrates git for version control.
...
This is by no means an exhaustive list of front-end technologies and resources.
I will update it in coming week with links to better resources and few more related technologies.


These are some more guides/roadmaps that will surely help you. Do check them out.

1.  [**Watch this if you want to be a Web Developer.**][2]

2.  [**Web Developer Roadmap.**][3]

3.  [**Front-End Developer Handbook 2017**][4] ( You can read this book online for free or download PDF, ePub or Mobi.)
